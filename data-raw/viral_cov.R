...
viral_cov_freq1 <- normalize_table(norm_tabs, viral_cov_freq1)
...
viral_cov_freq2 <- normalize_table(norm_tabs, viral_cov_freq2)
...
viral_cov_freq3 <- normalize_table(norm_tabs, viral_cov_freq3)
